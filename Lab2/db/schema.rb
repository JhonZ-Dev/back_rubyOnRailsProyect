...
ActiveRecord::Schema[7.1].define(version: 2023_12_09_220317) do
  ...
  create_table "productos_categorias", force: :cascade do |t|
    ...
    t.index ["categorias_id"], name: "index_productos_categorias_on_categorias_id"
    t.index ["producto_id"], name: "index_productos_categorias_on_producto_id"
  end

  add_foreign_key "movimiento_inventarios", "productos"
  add_foreign_key "productos_categorias", "categorias", column: "categorias_id"
  add_foreign_key "productos_categorias", "productos"
end
